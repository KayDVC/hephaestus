...
def run_command(cmd: list[Any], err: str, cleanup: Callable = None, enable_output: bool = True, log_level: int = logging.DEBUG, *args, **kwargs):
    ...
    """
    try:
        if _exec(cmd, enable_output=enable_output, log_level=log_level, *args, **kwargs) is None:
